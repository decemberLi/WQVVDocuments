...
@implementation WQDocumentsSetting

+ (WQDocumentsSetting *)defaultSetting
{
    static dispatch_once_t once;
    static WQDocumentsSetting *defaultSetting;
    dispatch_once(&once, ^ {
        defaultSetting = [[WQDocumentsSetting alloc] init];
